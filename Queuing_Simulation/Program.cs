...
namespace Queuing_Simulation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Parallel.For(1, 20, new ParallelOptions { MaxDegreeOfParallelism = 3 }, rho => // MaxDegreeOfParallelism n + 1, where n is the number of cores
            {
                // Diagnosis
                ...
                for (int i = 0; i < nrCustomers; i++) { arrivalDistributions[i] = new ExponentialDistribution(rng.Value, arrivalDistributionParameters[i]); }
...
//    Parallel.For(0, R, new ParallelOptions { MaxDegreeOfParallelism = 2 }, r => // MaxDegreeOfParallelism n + 1, where n is the number of cores
//    //for (int r = 0; r < R; r++)
//    {
//        double t = 0;
